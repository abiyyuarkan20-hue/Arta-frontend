      ...
      <div className="max-w-4xl mx-auto space-y-8 pb-12 animate-fade-in">
        <div className="bg-[#0B1221] rounded-[2rem] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-5xl font-black mb-4 tracking-tight leading-tight">Halo, {firstName}! <br/>Siap Memulai Bisnismu?</h1>
            <p className="text-slate-300 text-lg font-medium max-w-2xl leading-relaxed mb-8">
              Kami lihat kamu sedang merintis perjalanan bisnis. Jangan khawatir, Asisten AI Artha siap memandu dan menemukan model bisnis yang paling cocok dengan minat serta modalmu.
            </p>
            <button 
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-6 items-start">
            ...
            <div>
              <h3 className="font-black text-slate-800 text-xl mb-2">AI Profiling Akurat</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Jawab beberapa pertanyaan singkat dan biarkan AI kami menganalisis potensi dan minat terpendammu untuk memberikan rekomendasi terbaik.
              </p>
            </div>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-6 items-start">
            ...
            <div>
              <h3 className="font-black text-slate-800 text-xl mb-2">Simulasi Modal & Anggaran</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Tidak tahu cara mengalokasikan modal? Kami buatkan rancangan otomatis porsi CAPEX (Modal Tetap) dan OPEX (Operasional).
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-12 animate-fade-in">
      ...
      <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/30">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
          <div>
            <h3 className="text-xl font-black text-slate-800">Tren Arus Kas</h3>
            <p className="text-sm font-medium text-slate-400">Pemasukan vs Pengeluaran bulan Mei</p>
          </div>
